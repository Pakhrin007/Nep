...
import projectManagementTestimonials from '../../../../constants/project-management-testimonial/index';
...
const ProjectManagement = () => {
  return (
    <div className="flex flex-col gap-y-[24px]">
      ...
      <HeroSection
        title="Project Management for Smarter Collaboration"
      ...
      <Testimonial testimonials={projectManagementTestimonials} />
      <CTASection />
    </div>
  );
};
