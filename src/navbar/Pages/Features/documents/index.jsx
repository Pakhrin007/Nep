...
import documentsTestimonials from '../../../../constants/document-testimonial/index';
...
const Documents = () => {
  return (
    <div className="flex flex-col gap-y-[24px]">
      ...
      <HeroSection
        title="Documents for Smarter Collaboration"
      ...
      <Testimonial testimonials={documentsTestimonials} />
      <CTASection />
    </div>
  );
};
